...
public class ExtentReportManager implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		//Get page object from BaseTest
            bt=(BaseTest) result.getInstance();
            Page page=bt.page;
		//capture screenshot	
			String imgPath = new ScreenshotUtil().captureScreen(page,result.getName());
			test.addScreenCaptureFromPath(imgPath);
		//Attach video
		    String videoPath=VideoTraceManager.getVideoPath();
			if(videoPath!=null)
				{
                   test.info( "<a href='" + videoPath + "' target='_blank'>🎥 Watch Failure Video</a>" );
				}	
		// Attach Trace 
		    String tracePath = VideoTraceManager.getTracePath();
			if (tracePath != null) 
				{ 
					test.info( "<a href='" + tracePath + "' target='_blank'>📄 Download Trace</a>" );	
				}
